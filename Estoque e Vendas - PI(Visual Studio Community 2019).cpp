...
public:
    ...
    int Tipo_Cliente[51], CPF_Cliente[51], CNPJ_Cliente[51], Telefone_Cliente[51], Celular_Cliente[51], ID_Cliente = 0;
    string Nome_Cliente[51], Email_Cliente[51];

    int CNPJ_Fornecedor[51], Telefone_Fornecedor[51], Celular_Fornecedor[51], ID_Fornecedor = 0;
    ...
    int ID_Vendas = 0, Compra_CLi[51], Quant_Prod_Vendido[51], Cad_Vendas[51], id_pro_Vendido[51], Contador_Vendas = 0;
    ...
    void all_codes() {
        ...
        do {
            //criamos um DO para repetir os comandos ate que o valor da variavel seja o do WHILE
            cout << "                                    " << endl;
            cout << "Digite: " << endl;
            ...
            do {
                do {
                    retorno = scanf_s("%d", &opcao_main);
                    do {
                        letra = getchar();
                    } while (letra != '\n');
                    if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                } while (retorno == 0);
                if (opcao_main < 0) {
                    cout << "Digite um numero positivo." << endl;
                }
            } while (opcao_main < 0);
            //insersao de valor na variavel para que o switch comece e para terminar o DO
            switch (opcao_main) {
            ...
            case 1:
                ...
                cont_Usu = 1;
                break;
                //quebramos o efeito domino com o break e voltamos para o looping do DO-WHILE
            case 2:
                if (ID_Produto == 0) {
                    cout << "Voce nao tem um Produto Cadastrado para Cadastrar um Fornecedor! " << endl;
                    break;
                }
                cout << "                                    " << endl;
                cout << "Ola, vamos comecar o seu cadastro!" << endl;
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &CNPJ_Fornecedor[ID_Fornecedor]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Telefone_Fornecedor[ID_Fornecedor]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Celular_Fornecedor[ID_Fornecedor]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Id_Produto_Fornecido[ID_Fornecedor]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                ID_Fornecedor++;
                cont_Pro_For++;
                //adicionamos +1 para a varivel, para que nao faca a substituicao de cadastros futuros e para identificacao do cliente
                break;
            case 3:
                cout << "                                    " << endl;
                cout << "Ola, vamos comecar o seu cadastro!" << endl;
                ...
                do {
                    ...
                    do {
                        do {
                            retorno = scanf_s("%d", &Tipo_Cliente[ID_Cliente]);
                            do {
                                letra = getchar();
                            } while (letra != '\n');
                            if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                    ...
                    case 1:
                        //criamos um if para sabermos qual o tipo de cliente estamos cadastrando, assim conseguimos inserir CPF ou CNPJ
                        cout << "O CPF do Cliente e: " << endl;
                        do {
                            do {
                                retorno = scanf_s("%d", &CPF_Cliente[ID_Cliente]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        break;
                    case 2:
                        //caso nao seja uma pessoa fisica, pedimos o CNPJ, cortando o trabalho e deixando as variaveis utilizaveis, em vez de deixar elas paradas
                        cout << "O CNPj do Cliente e: " << endl;
                        do {
                            do {
                                retorno = scanf_s("%d", &CNPJ_Cliente[ID_Cliente]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Telefone_Cliente[ID_Cliente]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Celular_Cliente[ID_Cliente]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
            ...
            case 4:
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Quantidade_Estoque[ID_Produto]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%f", &Preco_Bruto[ID_Produto]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%f", &Preco_Venda[ID_Produto]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Codigo_Barra[ID_Produto]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &NCM[ID_Produto]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                cout << "A Unidade de Medida do Produto e: " << endl;
            ...
            case 5:
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &num_Local_Endereco[ID_Endereco]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &CEP_Endereco[ID_Endereco]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    ...
                    do {
                        do {
                            retorno = scanf_s("%d", &Cliente_Fornecedor[ID_Endereco]);
                            do {
                                letra = getchar();
                            } while (letra != '\n');
                            if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                    ...
                    case 1:
                        if (ID_Cliente == 0) {
                            cout << "Voce nao tem um Cliente Cadastrado para se referir ao Endereco! " << endl;
                            break;
                        }
                        cout << "Informe o ID do Cliente que se refere ao Endereco " << endl;
                        do {
                            do {
                                retorno = scanf_s("%d", &Cliente[ID_Endereco]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        //criamos um if para saber se o endereco cadastrado e de um fornecedor ou de um cliente
                        break;
                    case 2:
                        if (ID_Fornecedor == 0) {
                            cout << "Voce nao tem um Fornecedor Cadastrado para se referir ao Endereco! " << endl;
                            break;
                        }
                        cout << "Informe o ID do Fornecedor que se refere ao Endereco " << endl;
                        do {
                            do {
                                retorno = scanf_s("%d", &Fornecedor[ID_Endereco]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
            ...
            case 6:
                if (ID_Produto == 0 || ID_Cliente == 0) {
                    cout << "Voce nao tem um Produto ou um Cliente Cadastrado para se referir a Venda! " << endl;
                    break;
                }
                cout << "                                    " << endl;
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &id_pro_Vendido[ID_Vendas]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Quant_Prod_Vendido[ID_Vendas]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                ...
                do {
                    if (Quantidade_Estoque[id_pro_Vendido[ID_Vendas]] > Quant_Prod_Vendido[ID_Vendas]) {
                        Quantidade_Estoque[id_pro_Vendido[ID_Vendas]] - Quant_Prod_Vendido[ID_Vendas];
                    }
                    else {
                        cout << "Nao tem Produto suficiente para Comfirmar a Venda " << endl;
                        do {
                            do {
                                retorno = scanf_s("%d", &Quant_Prod_Vendido[ID_Vendas]);
                                do {
                ...
                } while (Quantidade_Estoque[id_pro_Vendido[ID_Vendas]] < Quant_Prod_Vendido[ID_Vendas]);
                Valor_Venda[ID_Vendas] = Quant_Prod_Vendido[ID_Vendas] * Preco_Venda[id_pro_Vendido[ID_Vendas]];
                Valor_Bruto_Venda[ID_Vendas] = Quant_Prod_Vendido[ID_Vendas] * Preco_Bruto[id_pro_Vendido[ID_Vendas]];
                Lucro_Venda[ID_Vendas] = Valor_Venda[ID_Vendas] - Valor_Bruto_Venda[ID_Vendas];
                ...
                do {
                    do {
                        retorno = scanf_s("%d", &Compra_CLi[ID_Vendas]);
                        do {
                            letra = getchar();
                        } while (letra != '\n');
                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
            ...
            case 7:
                ...
                do {
                    ...
                    do {
                        do {
                            retorno = scanf_s("%d", &opcao_modificar);
                            do {
                                letra = getchar();
                            } while (letra != '\n');
                            if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                    ...
                    case 1:
                        if (cont_Usu < 1) {
                            cout << "Voce nao tem um Usuario Cadastrado para ser Modificado! " << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                    ...
                    case 2:
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &id_modificar);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &CNPJ_Fornecedor[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Telefone_Fornecedor[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Celular_Fornecedor[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Id_Produto_Fornecido[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                    ...
                    case 3:
                        ...
                        do {
                            ...
                            do {
                                do {
                                    retorno = scanf_s("%d", &Tipo_Cliente[id_modificar]);
                                    do {
                                        letra = getchar();
                                    } while (letra != '\n');
                                    if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                            ...
                            case 1:
                                ...
                                do {
                                    do {
                                        retorno = scanf_s("%d", &CPF_Cliente[id_modificar]);
                                        do {
                                            letra = getchar();
                                        } while (letra != '\n');
                                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                            ...
                            case 2:
                                ...
                                do {
                                    do {
                                        retorno = scanf_s("%d", &CNPJ_Cliente[id_modificar]);
                                        do {
                                            letra = getchar();
                                        } while (letra != '\n');
                                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Telefone_Cliente[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Celular_Cliente[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                    ...
                    case 4:
                        if (ID_Produto == 0) {
                            cout << "Voce nao tem um Produto Cadastrado para Modificar! " << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Quantidade_Estoque[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%f", &Preco_Bruto[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%f", &Preco_Venda[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Codigo_Barra[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &NCM[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                    ...
                    case 5:
                        if (ID_Endereco == 0) {
                            cout << "Voce nao tem um Endereco Cadastrado para Modificar! " << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &num_Local_Endereco[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &CEP_Endereco[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            ...
                            do {
                                do {
                                    retorno = scanf_s("%d", &Cliente_Fornecedor[id_modificar]);
                                    do {
                                        letra = getchar();
                                    } while (letra != '\n');
                                    if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                            ...
                            case 1:
                                ...
                                do {
                                    do {
                                        retorno = scanf_s("%d", &Cliente[id_modificar]);
                                        do {
                                            letra = getchar();
                                        } while (letra != '\n');
                                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                            ...
                            case 2:
                                ...
                                do {
                                    do {
                                        retorno = scanf_s("%d", &Fornecedor[id_modificar]);
                                        do {
                                            letra = getchar();
                                        } while (letra != '\n');
                                        if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                    ...
                    case 6:
                        if (ID_Produto == 0 || ID_Cliente == 0) {
                            cout << "Voce nao tem um Produto ou um Cliente para se referir a Venda! " << endl;
                            break;
                        }
                        if (ID_Vendas == 0) {
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &id_pro_Vendido[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Quant_Prod_Vendido[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        do {
                            if (Quantidade_Estoque[id_pro_Vendido[id_modificar]] > Quant_Prod_Vendido[id_modificar]) {
                                Quantidade_Estoque[id_pro_Vendido[id_modificar]] - Quant_Prod_Vendido[id_modificar];
                            }
                            else {
                                cout << "Nao tem Produto suficiente para Comfirmar a Venda " << endl;
                                do {
                        ...
                        } while (Quantidade_Estoque[id_pro_Vendido[id_modificar]] < Quant_Prod_Vendido[id_modificar]);
                        Valor_Venda[id_modificar] = Quant_Prod_Vendido[id_modificar] * Preco_Venda[id_pro_Vendido[id_modificar]];
                        Valor_Bruto_Venda[id_modificar] = Quant_Prod_Vendido[id_modificar] * Preco_Bruto[id_pro_Vendido[id_modificar]];
                        Lucro_Venda[id_modificar] = Valor_Venda[id_modificar] - Valor_Bruto_Venda[id_modificar];
                        cout << "Informe a Data da Venda: " << endl;
                        ...
                        do {
                            do {
                                retorno = scanf_s("%d", &Compra_CLi[id_modificar]);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
            ...
            case 8:
                ...
                do {
                    ...
                    //insersao de um valor para a variavel opc_mostrar, para que comece o switch
                    switch (opc_mostrar) {
                    case 1:
                        //como so vamos ter um usuario cadastrado, nao precisamos colocar um if para colocarmos o for
                        if (cont_Usu == 0) {
                            cout << "Voce nao tem um Usuario Cadastrado para consultar" << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                    ...
                    case 2:
                        if (ID_Fornecedor == 0) {
                            cout << "Voce nao tem um Fornecedor Cadastrado para consultar! " << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                        ...
                        //um switch com if por termos poucas informacoes e nao necesitarmos de um switch, para uma consulta especifica ou para todos os cada
                        do {
                            do {
                                retorno = scanf_s("%d", &opc);
                                do {
                                    letra = getchar();
                                } while (letra != '\n');
                                if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                        ...
                        case 1:
                            ...
                            do {
                                do {
                                    retorno = scanf_s("%d", &consulta_unica);
                                    do {
                                        letra = getchar();
                                    } while (letra != '\n');
                                    if (retorno == 0) { cout << "Digite um valor numerico." << endl; }
                            ...
                            cout << "O Nome encontrado foi: " << Nome_Fornecedor[consulta_unica] << endl;
                            cout << "O CNPJ encontrado foi: " << CNPJ_Fornecedor[consulta_unica] << endl;
                            cout << "O Email encontrado foi: " << Email_Fornecedor[consulta_unica] << endl;
                            cout << "O Telefone encontrado foi: " << Telefone_Cliente[consulta_unica] << endl;
                            cout << "O Celular encontrado foi: " << Celular_Fornecedor[consulta_unica] << endl;
                            cout << "O Produto Fornecido encontrado foi: " << Nome_Produto[Id_Produto_Fornecido[consulta_unica]] << endl;
                            cout << "                    " << endl;
                            break;
                        case 2:
                            for (cont = 0; cont < ID_Fornecedor; cont++) {
                                //o ID_Fornecedor vai funcionar tambem como um contador de quantos cadastros ja foram feitos no total
                                cout << "                                    " << endl;
                                cout << "O Nome encontrado foi: " << Nome_Fornecedor[cont] << endl;
                                cout << "O CNPJ encontrado foi: " << CNPJ_Fornecedor[cont] << endl;
                                cout << "O Email encontrado foi: " << Email_Fornecedor[cont] << endl;
                                cout << "O Telefone encontrado foi: " << Telefone_Fornecedor[cont] << endl;
                                cout << "O Celular encontrado foi: " << Celular_Fornecedor[cont] << endl;
                                cout << "O Produto Fornecido encontrado foi: " << Nome_Fornecedor[Id_Produto_Fornecido[cont]] << endl;
                                cout << "                    " << endl;
                            }
                            //encerra o for
                            break;
                    ...
                    case 3:
                        ...
                        case 1:
                            ...
                            cout << "Resultados encontrados: " << endl;
                            cout << "O Nome encontrado foi: " << Nome_Cliente[consulta_unica] << endl;
                            cout << "O Email encontrado foi: " << Email_Cliente[consulta_unica] << endl;
                            cout << "O Telefone encontrado foi: " << Telefone_Cliente[consulta_unica] << endl;
                            cout << "O Celular encontrado foi: " << Celular_Cliente[consulta_unica] << endl;
                            if (Tipo_Cliente[consulta_unica] == 1) {
                                cout << "O CPF encontrado foi: " << CPF_Cliente[consulta_unica] << endl;;
                            }
                            else {
                                cout << "O CNPj encontrado foi: " << CNPJ_Cliente[consulta_unica] << endl;
                            }
                            cout << "                    " << endl;
                            break;
                        case 2:
                            for (cont = 0; cont < ID_Cliente; cont++) {
                                ...
                                cout << "O Email encontrado foi: " << Email_Cliente[cont] << endl;
                                cout << "O Telefone encontrado foi: " << Telefone_Cliente[cont] << endl;
                                cout << "O Celular encontrado foi: " << Celular_Cliente[cont] << endl;
                    ...
                    case 4:
                        if (ID_Produto == 0) {
                            cout << "Voce nao tem um Produto Cadastrado para consultar! " << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                        ...
                        case 1:
                            ...
                            cout << "Resultados encontrados: " << endl;
                            cout << "O Nome encontrado foi: " << Nome_Produto[consulta_unica] << endl;
                            cout << "A Data de Validade encontrada foi: " << Data_Validade[consulta_unica] << endl;
                            cout << "O Preco Bruto encontrado foi: " << Preco_Bruto[consulta_unica] << endl;
                            cout << "O Preco de Venda encontrado foi: " << Preco_Venda[consulta_unica] << endl;
                            cout << "O Codigo de Barra encontrado foi: " << Codigo_Barra[consulta_unica] << endl;
                            cout << "O NCM encontrado foi: " << NCM[consulta_unica] << endl;
                            cout << "A Unidade de Medida encontrada foi: " << Unidade_Medida[consulta_unica] << endl;
                            cout << "                    " << endl;
                            break;
                        case 2:
                            for (cont = 0; cont < ID_Produto; cont++) {
                                ...
                                cout << "A Data de Validade encontrada foi: " << Data_Validade[cont] << endl;
                                cout << "O Preco Bruto encontrado foi: " << Preco_Bruto[cont] << endl;
                                cout << "O Preco de Venda encontrado foi: " << Preco_Venda[cont] << endl;
                                cout << "O Codigo de Barra encontrado foi: " << Codigo_Barra[cont] << endl;
                                cout << "O NCM encontrado foi: " << NCM[cont] << endl;
                                cout << "A Unidade de Medida encontrada foi: " << Unidade_Medida[cont] << endl;
                                cout << "                    " << endl;
                            }
                            break;
                        default:
                    ...
                    case 5:
                        if (ID_Endereco == 0) {
                            cout << "Voce nao tem um Endereco Cadastrado para Consultar! " << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                        ...
                        case 1:
                            ...
                            cout << "Resultados encontrados: " << endl;
                            cout << "A Rua encontrada foi: " << Rua_Endereco[consulta_unica] << endl;
                            cout << "O Bairro encontrado foi: " << Bairro_Endereco[consulta_unica] << endl;
                            cout << "O Num do Local encontrado foi: " << num_Local_Endereco[consulta_unica] << endl;
                            cout << "O CEP encontrado foi: " << CEP_Endereco[consulta_unica] << endl;
                            if (Cliente_Fornecedor[consulta_unica] == 1) {
                                cout << "Este Endereco e de um Cliente: " << Cliente[consulta_unica] << endl;
                            }
                            else cout << "Este Endereco e de um Fornecedor: " << Fornecedor[consulta_unica] << endl;
                            cout << "                    " << endl;
                            break;
                        case 2:
                            for (cont = 0; cont < ID_Endereco; cont++) {
                                ...
                                cout << "O Bairro encontrado foi: " << Bairro_Endereco[cont] << endl;
                                cout << "O Num do Local encontrado foi: " << num_Local_Endereco[cont] << endl;
                                cout << "O CEP encontrado foi: " << CEP_Endereco[cont] << endl;
                                if (Cliente_Fornecedor[cont] == 1) {
                                    cout << "Este Endereco e de um Cliente: " << Cliente[cont] << endl;
                                }
                                else cout << "Este Endereco e de um Fornecedor: " << Fornecedor[cont] << endl;
                                cout << "                    " << endl;
                            }
                            break;
                        default:
                    ...
                    case 6:
                        if (ID_Vendas == 0) {
                            cout << "Voce nao tem uma Venda Cadastradoa para Consultar! " << endl;
                            break;
                        }
                        cout << "                                    " << endl;
                        ...
                        case 1:
                                ...
                                if (consulta_unica > ID_Fornecedor) {
                                    ...
                                    do {
                                        do {
                                            ...
                                            if (retorno == 0) { cout << "Digite um valor numérico." << endl; }
                                        } while (retorno == 0);
                                        if (consulta_unica < 0) {
                                            cout << "Digite um numero positivo." << endl;
                                        }
                            ...
                            cout << "Resultados encontrados: " << endl;
                            cout << "O Produto Vendido encontrado foi: " << Nome_Produto[id_pro_Vendido[consulta_unica]] << endl;
                            cout << "A Quantidade Vendida encontrada foi: " << Quant_Prod_Vendido[consulta_unica] << endl;
                            cout << "A Data da Venda encontrada foi: " << Data_Venda[consulta_unica] << endl;
                            cout << "O Cliente que fez a Compra encontrado foi: " << Nome_Cliente[Compra_CLi[consulta_unica]] << endl;
                            cout << "Valor da Venda foi: " << Valor_Venda[consulta_unica] << endl;
                            cout << "Lucro obtido foi: " << Lucro_Venda[consulta_unica] << endl;
                            cout << "                    " << endl;
                            break;
                        case 2:
                            cout << "Resultados encontrados: " << endl;
                            for (cont = 0; cont < ID_Vendas; cont++) {
                                cout << "                                    " << endl;
                                cout << "O Produto Vendido encontrado foi: " << Nome_Produto[id_pro_Vendido[cont]] << endl;
                                cout << "A Quantidade Vendida encontrada foi: " << Quant_Prod_Vendido[cont] << endl;
                                cout << "A Data da Venda encontrada foi: " << Data_Venda[cont] << endl;
                                cout << "O Cliente que fez a Compra encontrado foi: " << Nome_Cliente[Compra_CLi[cont]] << endl;
